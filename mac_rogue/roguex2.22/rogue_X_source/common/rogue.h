...
#if 0
#if !defined(ORIGINAL) && !defined(MAC) /* use compile option in MAC */
...
/*-----Juan-----*/
#define TOPLEFT		((unsigned short) 02000)
#define TOPRIGHT	((unsigned short) 04000)
#define BOTLEFT		((unsigned short) 010000)
#define BOTRIGHT	((unsigned short) 020000)
